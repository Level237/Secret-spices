...
<div id="space-hero-header" style="margin-top: 150px">
 ...
 <div class="container" style="margin-top: 50px;">
    ...
    <div class="margin-space">
        ...
        <div class="row mb-3">
            <h3 style="color:black"> 1. {{ __('Introduction') }}</h3>
            <p>
                {{ __("Les présentes conditions générales du site Web (ces « conditions » ou les « conditions générales du site Web ») contenues dans cette page Web régiront votre utilisation de ce site Web, y compris toutes les pages de ce site Web (collectivement désignées ci-dessous comme cette 'Site Internet'). Ces conditions s'appliquent pleinement à votre utilisation de ce site Web et en utilisant ce site Web, vous acceptez expressément tous les termes et conditions contenus dans les présentes dans leur intégralité. Vous ne devez pas utiliser ce site Web si vous avez des objections à l'une de ces conditions générales du site Web.") }}
           </p>
        </div>
        ...
        <div class="row mb-3">
            <h3 style="color:black"> 3. {{ __('Restrictions') }} </h3>
            <p>
                {{ __('Vous êtes expressément et catégoriquement limité à tout ce qui suit :') }} 
           </p>
           <ul>
                <li> - {{ __("Publier tout matériel du site Web dans n'importe quel média") }} ; </li>
                <li> - {{ __('Vendre, sous-licencier et/ou commercialiser autrement tout matériel du site Web') }} ; </li>
                <li> - {{ __('Exécuter publiquement et/ou montrer tout matériel du site Web') }} ; </li>
                <li> - {{ __("Utiliser ce site Web d'une manière qui est, ou peut être, préjudiciable à ce site Web") }} ; </li>
                <li> - {{ __("Utiliser ce site Web d'une manière qui affecte l'accès des utilisateurs à ce site Web") }} ; </li>
                <li> - {{ __("utiliser ce site Web contrairement aux lois et réglementations applicables, ou d'une manière qui cause ou peut causer un préjudice au site Web ou à toute personne ou entité commerciale") }} ; </li>
                <li> - {{ __("s'engager dans l'exploration de données, la collecte de données, l'extraction de données ou toute autre activité similaire en relation avec ce site Web, ou lors de l'utilisation de ce site Web") }} ; </li>
                <li> - {{ __("utiliser ce site Web pour faire de la publicité ou du marketing ; Certaines zones de ce site Web sont interdites d'accès par vous et SECRET peut en outre restreindre votre accès à toutes les zones de ce site Web, à tout moment, à sa seule et absolue discrétion. Tout nom d'utilisateur et mot de passe que vous pourriez avoir pour ce site Web sont confidentiels et vous devez maintenir la confidentialité de ces informations") }}.</li>
            </ul>
        ...
        <div class="row mb-3">
            <h3 style="color:black"> 5. {{ __('Aucune garantie') }} </h3>
            <p>
                {{ __('Ce site Web est fourni tel quel, avec tous les défauts, et aucune représentation ou garantie expresse ou implicite, de quelque nature que ce soit, liée à ce site Web ou aux éléments contenus sur ce site Web. De plus, rien de ce qui est contenu sur ce site Web ne doit être interprété comme vous fournissant des conseils') }}.
            </p>
        </div>
        ...
        <div class="row mb-3">
            <h3 style="color:black"> 7. {{ __('Indemnisation') }}</h3>
            <p>
                {{ __("Par la présente, vous indemnisez dans toute la mesure SECRET de et contre toutes les responsabilités, coûts, demandes, causes d'action, dommages et dépenses (y compris les honoraires d'avocat raisonnables) découlant de ou liés de quelque manière que ce soit à votre violation de l'une des dispositions des présentes Conditions") }}.
           </p>
           
        </div>

        <div class="row mb-3">
            <h3 style="color:black"> 8. {{ __('Divisibilité') }} </h3>
            <p>
                {{ __('Si une disposition de ces Conditions est jugée inapplicable ou invalide en vertu de toute loi applicable, cette inapplicabilité ou invalidité ne rendra pas ces Conditions inapplicables ou invalides dans leur ensemble, et ces dispositions seront supprimées sans affecter les autres dispositions des présentes') }}.
           </p>
        ...
        <div class="row mb-3">
            <h3 style="color:black"> 10. {{ __('Affectation') }} </h3>
            <p>
