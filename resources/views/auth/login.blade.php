    ...
    <div class="container-fluid">
        <div class="nk-header-wrap">
            <div class="nk-header-logo ms-n1">
                ...
                <div class="nk-navbar-toggle me-2"><button class="btn btn-sm btn-icon btn-zoom navbar-toggle d-sm-none"><em class="icon ni ni-menu-right"></em></button><button class="btn btn-md btn-icon btn-zoom navbar-toggle d-none d-sm-inline-flex"><em class="icon ni ni-menu-right"></em></button></div><a href="index.html.htm" class="logo-link">
            ...
            <nav class="nk-header-menu nk-navbar">
                <ul class="nk-nav">
                    <li class="nk-nav-item has-sub"><a href="#" class="nk-nav-link nk-nav-toggle"><span class="nk-nav-text">Dashboards</span></a>
                        <ul class="nk-nav-sub nk-nav-sub-lg">
                            <li class="nk-nav-item"><a href="index.html.htm" class="nk-nav-link bg-primary-soft-hover">
                                    <div class="media-group flex-grow-1">
                                        ...
                                        <div class="media-text flex-grow-1"><span class="title">Default</span><span class="sub-text d-block">Website Analytics</span></div>
                                    </div>
                                </a></li>
                            <li class="nk-nav-item"><a href="index-ecommerce.html.htm" class="nk-nav-link bg-secondary-soft-hover">
                                    <div class="media-group flex-grow-1">
                                        <div class="media media-md media-middle media-border text-bg-secondary-soft-outline">
                                            <em class="icon ni ni-cart-fill"></em></div>
                                        <div class="media-text flex-grow-1"><span class="title">eCommerce</span><span class="sub-text d-block">Sales reports</span></div>
                                    </div>
                                </a></li>
                            <li class="nk-nav-item"><a href="index-project.html.htm" class="nk-nav-link bg-success-soft-hover">
                                    <div class="media-group flex-grow-1">
                                        <div class="media media-md media-middle media-border text-bg-success-soft-outline">
                                            <em class="icon ni ni-link-group"></em></div>
                                        <div class="media-text flex-grow-1"><span class="title">Project</span><span class="sub-text d-block">Tasts, graphs & charts</span>
                                        </div>
                                    </div>
                                </a></li>
                            <li class="nk-nav-item"><a href="index-marketing.html.htm" class="nk-nav-link bg-info-soft-hover">
                                    <div class="media-group flex-grow-1">
                                        <div class="media media-md media-middle media-border text-bg-info-soft-outline">
                                            <em class="icon ni ni-growth-fill"></em></div>
                                        <div class="media-text flex-grow-1"><span class="title">Marketing</span><span class="sub-text d-block">Campaings & conversions</span>
                                        </div>
                                    </div>
                                </a></li>
                            <li class="nk-nav-item"><a href="index-nft.html.htm" class="nk-nav-link bg-danger-soft-hover">
                                    <div class="media-group flex-grow-1">
                                        <div class="media media-md media-middle media-border text-bg-danger-soft-outline">
                                            <em class="icon ni ni-'(-)'-fill"></em></div>
                                        <div class="media-text flex-grow-1"><span class="title">NFT</span><span class="sub-text d-block">Sell &amp; Create your own
                                                NFTs</span></div>
                                    </div>
                                </a></li>
                        </ul>
                    </li>
                    <li class="nk-nav-item has-sub"><a href="#" class="nk-nav-link nk-nav-toggle"><span class="nk-nav-text">Pages</span></a>
                        <ul class="nk-nav-sub">
                            <li class="nk-nav-item has-sub"><a href="#" class="nk-nav-link nk-nav-toggle"> Applications </a>
                                <ul class="nk-nav-sub">
                                    <li class="nk-nav-item"><a href="apps/fullcalendar/calendar.html.htm" class="nk-nav-link"> Calendar </a></li>
                                    <li class="nk-nav-item has-sub"><a href="#" class="nk-nav-link nk-nav-toggle"> Kanban board </a>
                                        <ul class="nk-nav-sub">
                                            <li class="nk-nav-item"><a href="apps/kanban/kanban-basic.html.htm" class="nk-nav-link"> Basic </a></li>
                                            <li class="nk-nav-item"><a href="apps/kanban/kanban-custom-board.html.htm" class="nk-nav-link"> Custom Board </a></li>
                                        </ul>
                                    </li>
                                    <li class="nk-nav-item has-sub"><a href="#" class="nk-nav-link nk-nav-toggle"> User Management </a>
                                        <ul class="nk-nav-sub">
                                            <li class="nk-nav-item"><a href="user-manage/user-list.html.htm" class="nk-nav-link"> Users List </a></li>
                                            <li class="nk-nav-item"><a href="user-manage/user-cards.html.htm" class="nk-nav-link"> Users Cards </a></li>
                                            <li class="nk-nav-item"><a href="user-manage/user-profile.html.htm" class="nk-nav-link"> Users Profile </a></li>
                                            <li class="nk-nav-item"><a href="user-manage/user-edit.html.htm" class="nk-nav-link"> Users Edit </a></li>
                                        </ul>
                                    </li>
                                    <li class="nk-nav-item has-sub"><a href="#" class="nk-nav-link nk-nav-toggle"> eCommerce </a>
                                        <ul class="nk-nav-sub">
                                            <li class="nk-nav-item"><a href="ecommerce/products.html.htm" class="nk-nav-link"> Products </a></li>
                                            <li class="nk-nav-item"><a href="ecommerce/categories.html.htm" class="nk-nav-link"> Categories </a></li>
                                            <li class="nk-nav-item"><a href="ecommerce/add-product.html.htm" class="nk-nav-link"> Add Product </a></li>
                                            <li class="nk-nav-item"><a href="ecommerce/edit-product.html.htm" class="nk-nav-link"> Edit Product </a></li>
                                            <li class="nk-nav-item"><a href="ecommerce/add-category.html.htm" class="nk-nav-link"> Add Category </a></li>
                                            <li class="nk-nav-item"><a href="ecommerce/edit-category.html.htm" class="nk-nav-link"> Edit Category </a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </li>
                            <li class="nk-nav-item"><a href="components/data-tables.html.htm" class="nk-nav-link"> Data tables </a></li>
                            <li class="nk-nav-item"><a href="components/chart.html.htm" class="nk-nav-link"> Chart </a></li>
                            <li class="nk-nav-item"><a href="components/sweet-alert.html.htm" class="nk-nav-link"> Sweetalert </a></li>
                            <li class="nk-nav-item"><a href="https://html.nioboard.themenio.com/auths/auth-register.html" class="nk-nav-link" target="_blank"> Auth Register </a></li>
                            <li class="nk-nav-item"><a href="auths/auth-login.html.htm" class="nk-nav-link" target="_blank"> Auth Login </a></li>
                            <li class="nk-nav-item"><a href="auths/auth-reset.html.htm" class="nk-nav-link" target="_blank"> Forgot Password </a></li>
                            <li class="nk-nav-item"><a href="error/page-404.html.htm" class="nk-nav-link" target="_blank"> Page 404 </a></li>
                        </ul>
                    </li>
                    <li class="nk-nav-item has-sub"><a href="#" class="nk-nav-link nk-nav-toggle"><span class="nk-nav-text">Ui Elements</span></a>
                            ...
                            <div class="nk-nav-mega nk-nav-mega-lg">
                                <div class="nk-nav-col">
                                    ...
                                    <ul class="link-list link-list-md link-list-hover-bg-primary">
                                        <li><a href="components/alerts.html.htm">Alerts</a></li>
                                        <li><a href="components/badge.html.htm">Badges</a></li>
                                        <li><a href="components/breadcrumb.html.htm">Breadcrumb</a></li>
                                        <li><a href="components/buttons.html.htm">Buttons</a></li>
                                        <li><a href="components/button-group.html.htm">Button group</a>
                                        </li>
                                        <li><a href="components/card.html.htm">Cards</a></li>
                                        <li><a href="components/close-button.html.htm">Close button</a>
                                        </li>
                                        <li><a href="components/list-group.html.htm">List group</a></li>
                                        <li><a href="components/pagination.html.htm">Pagination</a></li>
                                        <li><a href="components/placeholders.html.htm">Placeholders</a>
                                        </li>
                                        <li><a href="components/progress.html.htm">Progress</a></li>
                                        <li><a href="components/spinners.html.htm">Spinners</a></li>
                                        <li><a href="components/accordion.html.htm">Accordion</a></li>
                                    </ul>
                                </div>
                                <div class="nk-nav-col">
                                    <h6 class="nk-nav-heading">Components</h6>
                                    <ul class="link-list link-list-md link-list-hover-bg-primary">
                                        <li><a href="components/carousel.html.htm">Carousel</a></li>
                                        <li><a href="components/collapse.html.htm">Collapse</a></li>
                                        <li><a href="components/dropdowns.html.htm">Dropdowns</a></li>
                                        <li><a href="components/modal.html.htm">Modal</a></li>
                                        <li><a href="components/navs-tabs.html.htm">Tabs</a></li>
                                        <li><a href="components/offcanvas.html.htm">Offcanvas</a></li>
                                        <li><a href="components/popovers.html.htm">Popovers</a></li>
                                        <li><a href="components/toasts.html.htm">Toasts</a></li>
                                        <li><a href="components/tooltips.html.htm">Tooltips</a></li>
                                    </ul>
                                    <h6 class="nk-nav-heading">Layout</h6>
                                    <ul class="link-list link-list-md link-list-hover-bg-primary">
                                        <li><a href="layout/breakpoints.html.htm">Breakpoints</a></li>
                                        <li><a href="layout/containers.html.htm">Containers</a></li>
                                        <li><a href="layout/gutters.html.htm">Gutters</a></li>
                                    </ul>
                                </div>
                                <div class="nk-nav-col">
                                    <h6 class="nk-nav-heading">Utilities</h6>
                                    <ul class="link-list link-list-md link-list-hover-bg-primary">
                                        <li><a href="utilities/background.html.htm">Background</a></li>
                                        <li><a href="utilities/borders.html.htm">Borders</a></li>
                                        <li><a href="utilities/colors.html.htm">Colors</a></li>
                                        <li><a href="utilities/flex.html.htm">Flex</a></li>
                                        <li><a href="utilities/images.html.htm">Images</a></li>
                                        <li><a href="utilities/sizing.html.htm">Sizing</a></li>
                                        <li><a href="utilities/spacing.html.htm">Spacing</a></li>
                                        <li><a href="utilities/typography.html.htm">Typography</a></li>
                                        <li><a href="utilities/tables.html.htm">Tables</a></li>
                                        <li><a href="utilities/misc.html.htm">Miscellaneous</a></li>
                                    </ul>
                                </div>
                                <div class="nk-nav-col nk-nav-media"><img src="images/thumb/a.jpg" alt="" class="rounded-3"></div>
                            </div>
                        </div>
                    </li>
                </ul>
            ...
            <div class="nk-header-tools">
                <ul class="nk-quick-nav ms-2">
                    <li class="dropdown"><button class="btn btn-icon btn-sm btn-zoom d-sm-none" data-bs-toggle="dropdown" data-bs-auto-close="outside"><em class="icon ni ni-search"></em></button><button class="btn btn-icon btn-md btn-zoom d-none d-sm-inline-flex" data-bs-toggle="dropdown" data-bs-auto-close="outside"><em class="icon ni ni-search"></em></button>
                            ...
                            <div class="dropdown-content dropdown-content-x-lg py-3">
                                ...
                                <ul class="dropdown-list gap gy-2">
                                    <li>
                                        <div class="media-group">
                                            ...
                                            <div class="media-text">
                                                <div class="lead-text">Styled Doughnut Chart</div><span class="sub-text">1 days ago</span>
                                            </div>
                                    ...
                                    <li>
                                        <div class="media-group">
                                            <div class="media media-md media-middle media-circle text-bg-light">
                                                <em class="icon ni ni-clock"></em></div>
                                            <div class="media-text">
                                                <div class="lead-text">Custom Select Input</div><span class="sub-text">07 Aug</span>
                                            </div>
                                            <div class="media-action media-action-end"><button class="btn btn-md btn-zoom btn-icon me-n1"><em class="icon ni ni-trash"></em></button></div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="media-group">
                                            <div class="media media-md media-middle media-circle text-bg-light">
                                                <img src="images/avatar/a.jpg" alt=""></div>
                                            <div class="media-text">
                                                <div class="lead-text">Sharon Walker</div><span class="sub-text">Admin</span>
                                            </div>
                                            <div class="media-action media-action-end"><button class="btn btn-md btn-zoom btn-icon me-n1"><em class="icon ni ni-trash"></em></button></div>
                                        </div>
                                    </li>
                    ...
                    <li class="dropdown"><a href="#" data-bs-toggle="dropdown">
                            <div class="d-sm-none">
                                <div class="media media-md media-circle"><img src="images/avatar/a.jpg" alt="" class="img-thumbnail"></div>
                            </div>
                            <div class="d-none d-sm-block">
                                <div class="media media-circle"><img src="images/avatar/a.jpg" alt="" class="img-thumbnail"></div>
                            </div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-md">
                            <div class="dropdown-content dropdown-content-x-lg py-3 border-bottom border-light">
                                <div class="media-group">
                                    <div class="media media-xl media-middle media-circle"><img src="i
                                         c/" alt="" class="img-thumbnail">
                                    </div>
                                    <div class="media-text">
                                        "" <div class="lead-text">Wesley Burland</div><span class="sub-text">Owner & Founder</span>
                                    </div>
                                </div>
                            </div>
                            <div class="dropdown-content dropdown-content-x-lg py-3 border-bottom border-light">
                                <ul class="link-list">
                                    <li><a href="profile.html.htm"><em class="icon ni ni-user"></em>
                                            <span>My Profile</span></a></li>
                                    <li><a href="user-manage/user-cards.html.htm"><em class="icon ni ni-contact"></em> <span>My
                                                Contacts</span></a></li>
                                    <li><a href="profile-edit.html.htm"><em class="icon ni ni-setting-alt"></em> <span>Account
                                                Settings</span></a></li>
                                </ul>
                            </div>
                            <div class="dropdown-content dropdown-content-x-lg py-3">
