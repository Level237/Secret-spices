...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm3 center-gamut" style="">
            <i class="fas fa-angle-right" style="color: #c70609"> 35 Gr</i>
        </div>
    </div>
    ...
    <div class="row" style="margin-top:20px; margin-left:20px;">
        ...
        <div class="col d-flex flex-column product-row">
            <div class="p-2 fs-4 fw-normal">
                <img src="{{ asset('images/products/secret-viande.png')}}" alt="">
            </div>

            <div class="p-2 fs-4 fw-normal">
                Secret Epices Viande
            ...
            <div class="p-2 fs-4 fw-normal d-flex">
                ...
                <div class="p-2">
                    <img src="{{ asset('images/logos/logo-two.png')}}" width="354px" alt="">
                </div>
