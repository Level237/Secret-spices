 ...
 <div class="container" style="margin-top: 50px;">
    ...
    <div class="margin-space">
        ...
        <div class="row margin-space">
            <p>
                {{ __("Chez Keuni Foods accessible à l'adresse http://secret-spices.net/,  l'une de nos principales priorités est la confidentialité de nos visiteurs. Ce document de politique de confidentialité contient des types d'informations qui sont collectées et enregistrées par Keuni Foods et comment nous l'utilisons.") }}
            </p>
        </div>

        <div class="row margin-space">
            <p>
                {{ __("Si vous avez des questions supplémentaires ou souhaitez plus d'informations sur notre politique de confidentialité, n'hésitez pas à nous contacter. Cette politique de confidentialité s'applique uniquement à nos activités en ligne et est valable pour les visiteurs de notre site Web en ce qui concerne les informations qu'ils partagent et/ou collectent dans Keuni Foods. Cette politique ne s'applique pas aux informations collectées hors ligne ou via des canaux autres que ce site Web.") }}
           </p>
        </div>
        ...
        <div class="row mb-3">
           ...
           <ul>
                ...
                <li> - {{ __("Communiquer avec vous, directement ou par l'intermédiaire de l'un de nos partenaires") }}, <br>
